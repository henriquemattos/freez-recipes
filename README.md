...
* Para listar receitas por categoria usando o slug: `[freezrecipes category="receitas-praticas"]`.
* Para listar receitas de várias categorias usando o slug: `[freezrecipes category="receitas-praticas,receitas-complicadas"]`.
